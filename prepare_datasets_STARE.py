...
#------------Path of the images --------------------------------------------------------------
# train
original_imgs_train = dataset + "/stare-images/train/"
groundTruth_imgs_train = dataset + "/labels-ah/train/"
borderMasks_imgs_train = dataset + "/train_mask/"
# test
original_imgs_test = dataset + "/stare-images/test/"
groundTruth_imgs_test = dataset + "/labels-ah/test/"
borderMasks_imgs_test = dataset + "/test_mask/"
#---------------------------------------------------------------------------------------------
