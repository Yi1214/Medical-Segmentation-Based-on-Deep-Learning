...
# test
original_imgs_test = "/Test_Augment_padding/DRIVE/test/images/degree_0/"
groundTruth_imgs_test = "/Test_Augment_padding/DRIVE/test/1st_manual/original/"
borderMasks_imgs_test = "/Test_Augment_padding/DRIVE/test/mask/original/"
#---------------------------------------------------------------------------------------------
...
height = 0
width = 0
dataset_path = "/Test_Augment_padding/DRIVE/"
...
def get_datasets(imgs_dir, groundTruth_dir, borderMasks_dir, train_test="null"):
    ...
    # assert (int(np.max(border_masks)) == 255)
    print(int(np.max(border_masks)))
    assert (int(np.min(border_masks)) == 0)
    print("border_masks are correctly within pixel value range 0-255 (black-white)")
...
write_hdf5(imgs_test, dataset_path + dataset + "_imgs_test_degree0.hdf5")
# write_hdf5(groundTruth_test, dataset_path + dataset + "_groundTruth_original.hdf5")
# write_hdf5(border_masks_test, dataset_path + dataset + "_borderMasks_original.hdf5")
